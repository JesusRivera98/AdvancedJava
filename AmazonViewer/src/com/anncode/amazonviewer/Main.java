...
/**
 * <h1>AmazonViewer</h1>
 * AmazonViewer is a program that allows you to view Movies, Series with their respective Chapters,
 *   * Books and Magazines. It allows you to generate general and dated reports.
 * <p>
 * There are some rules such as that all elements can be viewed or read except for the Magazines,
 * they can only be viewed as an exhibition without being read.
 * 
 * @author anncode
...
public class Main {
	...
	public static void showMenu() {
		...
		do {
			...
			System.out.println("");
			System.out.println("Select the desires option number);
	...
	public static void showBooks() {
		...
		do {
			...
			AtomicInteger atomicInteger = new AtomicInteger(1);
			books.forEach(b -> System.out.println(atomicInteger.getAndIncrement() + ". " + b.getTitle() + " Visto: " + b.isRead()));
